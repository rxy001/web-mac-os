...
const text = `1. 关于 \`webpackPreload wepbackPrefetch\` 在 webpack 4 中已支持， 但是 htmlWebpackPlugin 并不支持此功能，此webpack api 影响性能，导致无法生成 link tag。通过 htmlWebpackPlugin 的 plugin [@vue/preload-webpack-plugin](https://www.npmjs.com/package/@vue/preload-webpack-plugin) 可解决。
